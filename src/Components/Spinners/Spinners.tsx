...
const Spinners = ({ isLoading = true }: Props) => {
  ...
  return (
    <div
      id="loading-spinner"
      className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-paper-white/90"
    >
      <div
        ...
        data-testid="loader"
      >
        <div className="relative flex h-16 w-16 items-center justify-center text-sunrise-coral">
